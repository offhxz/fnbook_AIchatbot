...
export default function ChatbotPopup() {
    ...
    const [messages, setMessages] = useState([
        { text: "Olá! Como posso ajudar a verificar sua notícia hoje?", sender: 'bot' }
    ]);
    ...
    const handleSendMessage = async () => {
        ...
        try {
            const response = await fetch('http://localhost:3001/api/analisar', { // Endpoint do seu backend Node.js
                method: 'POST',
                headers: {
